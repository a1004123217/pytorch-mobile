...
class ghostnet_inner(nn.Module):
    def __init__(self, cfgs, num_classes=1000, width=1.0, dropout=0.2):
        super(ghostnet_inner, self).__init__()
...
def GhostNet(pretrained=True, **kwargs):
    cfgs = [
        # k, t, c, SE, s 
        # stage1
        [[3,  16,  16, 0, 1]],
    ...
    model = ghostnet_inner(cfgs, num_classes=1000, width=1.0, dropout=0.2)
    if pretrained:
