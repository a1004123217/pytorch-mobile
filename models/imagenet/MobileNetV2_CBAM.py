...
def MobileNetV2_CBAM(pretrained=True, **kwargs):
    model = MobileNetV2(**kwargs)
    if pretrained:
        pretrained_dict = torch.load('/workspace/mnt/group/other/luchao/finecls/pytorch-classification/checkpoints_mibilev2_cbam/imagenet/MobileNetV2_CBAM/model_best_69.5.pth.tar')
